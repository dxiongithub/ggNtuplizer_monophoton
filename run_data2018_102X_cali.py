...
process.source = cms.Source("PoolSource",
        ...
        'file:C524DC5B-6606-434B-A2A1-BC9ED8F1762F.root'
        )
                            )
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ggtree_data_cali.root'))
