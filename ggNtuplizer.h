...
//07.14.2020 adding track information
...
class ggNtuplizer : public edm::EDAnalyzer {
 ...
 private:
  ...
  //edm::EDGetTokenT<reco::PhotonCore>               recophotonCollection_;

  //ootphoton//
  edm::EDGetTokenT<edm::View<pat::Photon> >        OOTphotonCollection_;
  edm::EDGetTokenT<reco::PhotonCollection>         recoOOTphotonCollection_;
  ////////////
