...
//added reco oot photon collection on 03.19.2020
  ...
  hltPrescaleProvider_(ps, consumesCollector(), *this)
{
  ...
  recoOOTphotonCollection_   = consumes<reco::PhotonCollection>        (ps.getParameter<InputTag>("recoOOTPhotonSrc"));
  ////////////
  ...
  //recophotonCollection_      = consumes<reco::PhotonCore>              (ps.getParameter<InputTag>("recoPhotonSrc"));
